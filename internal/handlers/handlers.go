...
import (
	...
	"github.com/dukesp69/bookings/internal/forms"
	...
	"github.com/dukesp69/bookings/internal/repository"
	"github.com/dukesp69/bookings/internal/repository/dbrepo"
...
// PostReservation handles the post of the reservation form
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	//for dates we need to cast from string to time.Time as model says
	// sd := r.Form.Get("start_date")
	// ed := r.Form.Get("end_date")
	// 2022-12-21 --- 01/02 03:04:05PM '06 -0700
	...
	newReservationID, err := m.DB.InserReservation(reservation)
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
...
// Generals renders the generals room page and displays form
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "generals.page.tmpl", &models.TemplateData{})
}

// Majors renders the majors room page and displays form
...
// PostAvailability handles request from availability and displays form
...
// AvailabilityJSON handles request from availability and send JSON response
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	reservation, ok := m.App.Session.Get(r.Context(), "reservation").(models.Reservation)
	if !ok {
		m.App.ErrorLog.Println("cannot get item from seession")
...
// ChooseRoom displays list of availables rooms
func (m *Repository) ChooseRoom(w http.ResponseWriter, r *http.Request) {
	//convert  to int the paaram of the URL we defined in routes.go which is id
	...
	//casting reservation value in session to models.Reservation
...
// BookRoom takes URL parameters, builds a sessional variable, and take user to reservation screen
...
// PostShowLogin requues to authenticate user
...
// AdminShowReservation show the reservation in the amdin dasboard
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	//asume there is no month or year specify
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// that does not exist in our posted data, and if the restriction id > 0, then its is a block we need to remove
